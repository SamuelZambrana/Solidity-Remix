...
contract IntercambioSeguro {
    ...
    event IntercambioRealizado(address seller, address buyer, address erc20TokenAddress, address erc721TokenAddress, uint erc721TokenIs, uint price);
    ...
    function executeTrade() public {
        ...
        //emit IntercambioRealizado(address seller, address buyer, address erc20TokenAddress, address erc721TokenAddress, uint erc721TokenIs, uint price);
